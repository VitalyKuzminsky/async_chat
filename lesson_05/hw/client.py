...
from common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, RESPONSE, PORT_DEFAULT, ERROR, IP_ADDR_DEFAULT
...
def create_arg_parser():
    ...
    parser.add_argument('addr', default=IP_ADDR_DEFAULT, nargs='?')
